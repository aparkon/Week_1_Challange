...
if PV>=LP:
    ...
    print("loan is too exepensive and not worth the price")
...
FV2=new_loan.get("future_value")
RM2=new_loan.get("remaining_months")

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
PV2=FV2/(1+0.2/12)**RM2
print(f"The present value of the loan is: {PV2:.2f}")
...
print('inexpensive loan: ', inexpensive_loans)    
